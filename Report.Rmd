...
### Question: Is there a difference in median after tax household income between 2015 and 2020?
```{r, include = TRUE, message = FALSE, warning = FALSE}
...
### Question: Is there a significant difference in income between households of 5 or more people and 4 persons (in 2020)?
...
```
### From the boxplot and the qq-plot, we can see that the t-test assumptions are not satisfied
...
### Question: Is there a difference in median income between Households with and without children?
